...
//*****반드시 아래 다시 공부해서 확인하기!!*****
//*****중요*****  아래 원리가, '생성자 주입'의 어떤 원리와 결부되어 의존성 주입이 되는 것인지 정확히 확인하기!!
//- 예를 들어, BoardController에서 BoardService 를 주입받으면, private final BoardService boardService 부분을 작성하고,
//  이에 필드를 포함하는 BoardController 생성자를 만들어줘야 생성자 주입이 완료되는 건데,
//  이 부분을 @RequiredArgsConstructor 를 붙여줌으로써, 원래 작성해줘야 하는 아래 BoardController의 생성자
//  public BoardController(BoardService boardService){
//      this.boardService = boardServivce;
//  }
// 를 @RequiredArgsConstructor가 대신 작성해주는 것이다!
...
public class 컨트롤러_AllArgsConstructor {
}
